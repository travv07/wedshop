				...
				<thead>
			  	...
			  	<tbody>
				    <tr>
	                    ...
	                    <td><a href="edit-user.php?id=<?php echo $row['id'] ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
	                    <td><a href="delete-user.phpid=<?php echo $row['id'] ?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
				    </tr>
			  	</tbody>
			</table>
		<?php } ?>
