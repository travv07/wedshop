...
<body>
	<?php 
		...
		if(isset($_POST['update'])){
			...
			$queri = "update Products set name ='$name', description='$des', quality='$quality',price='$price',image='$image',category='$category' where id_product='$id_old'";	
	...
	<div class="container-fluid main-container">
		<div class="col-md-2 sidebar">
			<ul class="nav nav-pills nav-stacked">
				...
				<li><a href="product-admin">Product</a></li>
				<li><a href="#">Link</a></li>
				<li><a href="#">Link</a></li>
			</ul>
		</div>
			...
			<div class="row1">
				...
				<div class="khungrow">
					<form action="edit-product.php" method="post">
						<input type="hidden" class="form-control" id="id" name="id" value="<?php echo $row['id_product'] ?>">
					    ...
					    <div class="form-group1">
						    <div class="row-left">
					      	...
					      	<div class="row-right">
					      		<input type="text" class="form-control" id="quality" name="quality" value="<?php echo $row['quality'] ?>">
					      	</div>
					    </div>
					    <div class="form-group1">
					    	<div class="row-left">
